...
namespace AgilAds.DAL
{
    ...
    public class GenericRepository<TEntity> where TEntity : class
    {
        ...
        internal AgilAdsDataContext Context;
        ...
        public GenericRepository(AgilAdsDataContext context)
        {
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        public TEntity GetFunc(Func<TEntity, Boolean> where)
        {
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        public void DeleteFunc(Func<TEntity, Boolean> where)
        {
        ...
        /// specified criteria or a default value if no match found</returns>
